...
For now, the program is called from terminal. I might add a UI for better user access.
(Maybe even a visualiser)

Read the "instructions.pdf" file to understand the parametars.
